...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/02_AgentV1.ipynb.

# %% auto 0
__all__ = ['MD', 'create_system_prompt', 'md_user', 'str2key_value', 'md_tool', 'md_assistant']

# %% ../nbs/02_AgentV1.ipynb 2
...
# %% ../nbs/02_AgentV1.ipynb 3
from IPython.display import Markdown, display
MD = lambda x: display(Markdown(x))

# %% ../nbs/02_AgentV1.ipynb 5
